 ...
 * environment in which it runs. This is part of the help system for the JavaNews
 * application.
 * @version 1.000
...
public class Help_About extends JInternalFrame
{
  ...
  private static final String className = "javanews.gui.internalframe.Help_About";
  ...
  public Help_About()
  {
    super("About JavaNews", true, true, true, true);
    super.setLayer(1);
    ...
    {
      log.throwing(className, "actionPerformed()", ioX);
