...
/* Class name: Help_Using
 * File name:  Help_Using.java
 * Project:    JavaNews - PSE Monitoring
 * Copyright:  © 2007-2009 Alexander J. Harris, all rights reserved
 * Created:    11-Jan-2009 17:43:57
...
/**
 * Responsible for providing an overview of help topic available to the user
 * about the application. This is part of the help system for the JavaNews application.
 * @version 1.000
 * @author Alex Harris (email: Alexander.J.Harris(at)btinternet.com)
 */

public class Help_Using extends JInternalFrame
{
  /** The logger to be used for writing messages to the application log */
  private Logger log;
  /** The unique name of the logger within the application */
  private static final String className = "javanews.gui.internalframe.Help_Using";

  /**
   * This initialises the class and its associated logger instance. It displays the contents of the
   * using.html file located in the HTML folder of the application directory.
   */
  public Help_Using()
  {
    super("Using JavaNews", true, true, true, true);
    super.setLayer(1);
    ...
    try
    {
      ...
      URL urlHelp = new URL("file","localhost","HTML/using.html");
